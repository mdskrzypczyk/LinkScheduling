...
def main():
    ...
    full_topology = gen_plus_topology(num_end_node_comm_q=2, num_end_node_storage_q=4, num_rep_comm_q=2,
                                      num_rep_storage_q=4)
    half_topology1 = gen_plus_topology(num_end_node_comm_q=1, num_end_node_storage_q=2, num_rep_comm_q=1,
                                       num_rep_storage_q=2)
    half_topology2 = gen_plus_topology(num_end_node_comm_q=1, num_end_node_storage_q=2, num_rep_comm_q=1,
                                       num_rep_storage_q=2)
    slot_size = 0.01
    ...
    while num_results < 100:
        ...
        for fidelity in fidelities:
            ...
            ...
            # Generate one set of demands, construct two tasksets, one where demands use all resources and one where
            # demands use half resources
