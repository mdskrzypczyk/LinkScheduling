...
from jobscheduling.topology import gen_surfnet_topology
...
def main():
    ...
    network_loads = [0.5, 1, 2, 3, 4, 5, 10, 15, 20, 25, 30, 35, 40, 50, 60, 80, 100, 200, 300]
    topology = gen_surfnet_topology()
    slot_size = 0.01
    schedulers = get_schedulers()
    results_file = "surfnet_load_results.json"
